...
// Fetch blood types from the 'blood' table
$sql_blood_types = "SELECT DISTINCT bloodname FROM blood";
$result_blood_types = mysqli_query($con, $sql_blood_types);

if (!$result_blood_types) {
    die("Error fetching blood types: " . mysqli_error($con));
}
                ...
                <div class="km__donate__form">
                    ...
                    <div class="km__form__donat">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select id="bloodType" name="blood_type" required>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result_blood_types)): ?>
                                            <option value="<?php echo htmlspecialchars($row['bloodname']); ?>">
                                                <?php echo htmlspecialchars($row['bloodname']); ?>
                                            </option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <textarea name="location" id="location" cols="10" rows="3" placeholder="Enter Your Location"></textarea>
                                </div>
                            </div>
