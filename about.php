    ...
    <div class="row align-items-center g-0 g-xxl-5 g-xl-5 g-lg-5">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="km__who__content">
          ...
          <p class="mb-30">We are dedicated to improving healthcare through efficient blood bank management. Our team
            focuses on ensuring a steady and safe supply of blood through our comprehensive management system, designed
            to streamline donation, storage, and distribution processes.
          </p>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
  ...
  <div class="container">
    ...
    <div class="testi_slider slider-spacing">
      ...
      while ($data = mysqli_fetch_assoc($res)) {
        ?>
        <div class="testi_slider_item h-100 position-relative information">
          ...
          <div>
            <img src="admin/image/information_img/<?php echo $data['image'] ?>" class="info_img">
          </div>
        </div>
      <?php } ?>
    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                  <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                    <div class="p_content_left">
                      <h5>Registration</h5>
                      <p>
                        The first step to becoming a life-saving donor is to create a donor profile. This allows us to
                        keep track of your donation history, eligibility, and health status.
                      </p>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                  <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                    ...
                    <div class="p_content_left p_content_right">
                      ...
                      <p>The Screening Test process is critical for ensuring that donated blood is safe for transfusion.
                        This process includes a series of tests and evaluations performed both before and after blood
                        donation to check for any health risks.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                  <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                    <div class="p_content_left">
                      <h5>Donation</h5>
                      <p>
                        Blood donation is a simple yet powerful act that saves lives. By donating just one unit of
                        blood, you can help up to three people in need of transfusions, whether for surgeries, trauma
                        cases, or chronic conditions.
                      </p>
                    </div>
              ...
              <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-6 col-md-7 col-sm-9 col-12">
                  <div class="progress_content d-flex align-items-center gap-xl-5 gap-lg-5 gap-md-4 gap-sm-3 gap-3">
                    ...
                    <div class="p_content_left p_content_right">
                      <h5>Rest &amp; Refresh</h5>
                      <p>After donating blood, it's essential to rest and refresh to ensure a smooth recovery. Donors
                        are typically advised to relax for 10-15 minutes in a designated rest area. During this time,
                        refreshments like juice, water, and light snacks are provided to help replenish fluids and
                        energy.
                      </p>
                    </div>
                  </div>
