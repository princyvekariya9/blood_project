            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 d-flex justify-content-end">
                    <form method="get" class="d-flex gap-2">
                        <input type="text" name="search" class="form-control" placeholder="Search admin name"
                            value="<?php echo htmlspecialchars($search); ?>">
                        <input type="submit" name="submit" value="search" class="btn btn-dark">
                    </form>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="add_admin.php" class="btn btn-dark rounded-pill ms-2"><i class="fa-solid fa-plus"></i></a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    while ($data = mysqli_fetch_assoc($res)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="action_icon">
                                                <a href="view_admin.php?id=<?php echo $data['id']; ?>"><i
                                                        class="fa-solid fa-trash-can"></i></a>
                                                <a href="add_admin.php?id=<?php echo $data['id']; ?>"><i
