        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-4 ">
          <div class="news_content_item">
            <div class="news_img ">
              ...
              <a href="assets/images/n1.jpg" data-fancybox=""><i class="fa-solid fa-plus"></i></a>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-4 ">
          <div class="news_content_item">
            <div class="news_img ">
              ...
              <a href="assets/images/n2.jpg" data-fancybox=""><i class="fa-solid fa-plus"></i></a>
            </div>
            <div class="news_content">
              <div class="meta d-flex gap-4">
                <span><i class="fa-regular fa-clock"></i> 18 Feb, 2022</span>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
          <div class="news_content_item">
            <div class="news_img ">
              ...
              <a href="assets/images/n3.jpg" data-fancybox=""><i class="fa-solid fa-plus"></i></a>
            </div>
            <div class="news_content">
              <div class="meta d-flex gap-4">
                <span><i class="fa-regular fa-clock"></i> 18 Feb, 2022</span>
